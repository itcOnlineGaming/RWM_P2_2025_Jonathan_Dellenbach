<script lang="ts">
  ...
  // Get the before mood from store
...
<div class="conclusion-container">
  <div class="context-container">
    ...
    <p>Thank you for testing my Visual Meditation Component.<br> I am a 4th year Computer Games Development student working on a Self Regulated Learning (SRL) project focused on emotional management.</p>
    
    <h2>Purpose</h2>
    <p>This visual meditation exercise is designed to help users de-stress through guided visual breathing.The 4-2-4-2 breathing pattern helps activate the body's relaxation response and supports emotional regulation.</p>
  </div>
  ...
  <div class="container">
    <div class="button-container">
      <a href={`${base}/`} class="submit-button">Go To The Start!</a>
    </div>
  </div>
</div>
...
<style>
  ...
  .spectrum-container {
    display: flex;
    align-items: center;
    justify-content: space-between; /* left label, middle buttons, right label */
    max-width: 100%;
    gap: 1rem;
    }
    ...
    flex: 1; /* takes up all space between labels */
    }
